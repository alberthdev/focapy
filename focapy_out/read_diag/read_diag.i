...
%inline %{
  diag_header_chan_list **mk_diag_header_chan_listpp(diag_header_chan_list *f) {
    diag_header_chan_list **diag_header_chan_listpp = (diag_header_chan_list **) malloc(sizeof(diag_header_chan_list *));
    *diag_header_chan_listpp = f;
    return diag_header_chan_listpp;
  }
%}

%inline %{
  diag_data_chan_list **mk_diag_data_chan_listpp(diag_data_chan_list *f) {
    diag_data_chan_list **diag_data_chan_listpp = (diag_data_chan_list **) malloc(sizeof(diag_data_chan_list *));
    *diag_data_chan_listpp = f;
    return diag_data_chan_listpp;
  }
%}
