...
! Declare public and private
  ...
  public :: read_radiag_header_focapy_orig
  public :: read_radiag_data_focapy_orig
...
subroutine read_radiag_header_focapy_orig(ftin,npred_radiag,retrieval,header_fix,header_chan,data_name,iflag,lverbose)
!                .      .    .                                       .
...
! Declare passed arguments
  ...
  type(diag_header_chan_list),allocatable,intent(out) :: header_chan(:)
...
end subroutine read_radiag_header_focapy_orig

subroutine read_radiag_data_focapy_orig(ftin,header_fix,retrieval,data_fix,data_chan,data_extra,iflag )
!                .      .    .                                       .
...
! Declare passed arguments
  ...
  type(diag_data_chan_list)  ,allocatable, intent(out) :: data_chan(:)
...
end subroutine read_radiag_data_focapy_orig
