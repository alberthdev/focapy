...
! Declare public and private
  ...
  public :: inc_mean
  public :: ret_mean
  public :: ret_mean_from_array_focapy_orig

  public :: print_array_focapy_orig
  public :: write_array_focapy_orig
  public :: read_array_focapy_orig
...
contains
  ...
  real(r_single) function ret_mean_from_array_focapy_orig(array, ndata) !bind(c)
    ...
    ret_mean_from_array_focapy_orig = total / n
  end function ret_mean_from_array_focapy_orig

  subroutine print_array_focapy_orig(array, ndata) !bind(c)
    integer(i_kind),intent(in)              :: ndata
    real(r_single),dimension(:),intent(in)  :: array
    ...
    enddo
  end subroutine print_array_focapy_orig

  subroutine write_array_focapy_orig(lun,filename,array,ndata)
    ...
    write(lun) array
    close(lun)
  end subroutine write_array_focapy_orig

  subroutine read_array_focapy_orig(lun,filename,array,ndata) !bind(c)
    integer(i_kind), intent(in)                           :: lun
    character(len=120),intent(in)                         :: filename
    ...
    read(lun) array
    close(lun)
  end subroutine read_array_focapy_orig
