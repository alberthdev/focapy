...
contains
  ...
  real(r_single) function ret_mean_from_array_focapy_orig(array, ndata)
  ...
  subroutine print_array_focapy_orig(array, ndata)
    integer(i_kind),intent(in)              :: ndata
    real(r_single),dimension(:),intent(in)  :: array
  ...
  subroutine read_array_focapy_orig(lun,filename,array,ndata)
    integer(i_kind), intent(in)                           :: lun
    character(len=120),intent(in)                              :: filename
